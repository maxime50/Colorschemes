local LSP = {
		...
		LspDiagnosticsUnderlineError = {sp = C.error_red, style = "undercurl", },
		LspDiagnosticsUnderlineWarning = {sp = C.warning_orange, style = "undercurl", },
		LspDiagnosticsUnderlineInformation = {sp = C.info_yellow, style = "undercurl", },
		LspDiagnosticsUnderlineHint = {sp = C.hint_blue, style = "undercurl", },
